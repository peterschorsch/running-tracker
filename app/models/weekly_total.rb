class WeeklyTotal < ApplicationRecord
	...
	def set_weekly_total_to_zero(date = Date.current)
		...
		self.update_attributes(mileage_total: BigDecimal('0'), mileage_goal: mileage_goal, met_goal: false, time_in_seconds: 0, number_of_runs: 0, elevation_gain: 0, week_start: date.beginning_of_week, week_end: date.end_of_week, frozen_flag: false)
	end
