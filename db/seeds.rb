...
puts @run.inspect
@run = Run.find_or_create_by(name: "Bucktown 5K Run", start_time: DateTime.new(2019, 10, 6, 8, 30, 0).in_time_zone("Central Time (US & Canada)"), hours: "0", minutes: "18", seconds: "4", pace: "5:49", city: "Chicago", notes: "Bib#: 4291", gear_id: Gear.find_shoe("Adios 4").id, planned_mileage: BigDecimal('3.1'), mileage_total: BigDecimal('3.1'), elevation_gain: BigDecimal('0'), state_id: State.find_by_abbr("IL").id, run_type_id: RunType.named("Race").id, user_id: user_id, personal_best: true)
puts @run.inspect
@run = Run.find_or_create_by(name: "Bank of America Chicago Marathon", start_time: DateTime.new(2019, 10, 13, 7, 30, 0).in_time_zone("Central Time (US & Canada)"), hours: "2", minutes: "43", seconds: "08", pace: "6:14", notes: "Bib#: 11184", city: "Chicago", gear_id: Gear.find_shoe("Adios 4").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('100'), state_id: State.find_by_abbr("IL").id, run_type_id: RunType.named("Race").id, user_id: user_id, personal_best: true)
puts @run.inspect
@run = Run.find_or_create_by(name: "TCS New York City Marathon", start_time: DateTime.new(2019, 11, 3, 9, 42, 0).in_time_zone("Eastern Time (US & Canada)"), hours: "3", minutes: "7", seconds: "16", pace: "7:09", notes: "Bib#: 2052", city: "New York", gear_id: Gear.find_shoe_with_color("Cloudswift", "Rock/Slate").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('830'), state_id: State.find_by_abbr("NY").id, run_type_id: RunType.named("Race").id, user_id: user_id)
puts @run.inspect
puts "----------2020----------"
@run = Run.find_or_create_by(name: "Los Angeles Marathon", start_time: DateTime.new(2020, 3, 8, 6, 55, 0).in_time_zone("Pacific Time (US & Canada)"), hours: "2", minutes: "48", seconds: "35", pace: "6:26", notes: "Bib#: 1356", city: "Los Angeles", gear_id: Gear.find_shoe("Adios 4").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('850'), state_id: State.find_by_abbr("CA").id, run_type_id: RunType.named("Race").id, user_id: user_id)
puts @run.inspect
@run = Run.find_or_create_by(name: "Testing", start_time: DateTime.new(2020, 9, 5, 10, 0, 0).in_time_zone("Pacific Time (US & Canada)"), hours: "2", minutes: "48", seconds: "35", pace: "6:26", notes: "Bib#: 1356", city: "Los Angeles", gear_id: Gear.find_shoe("Adios 4").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('850'), state_id: State.find_by_abbr("CA").id, run_type_id: RunType.named("Long Run").id, user_id: user_id)
puts @run.inspect
@run = Run.find_or_create_by(name: "Testing 2", start_time: DateTime.new(2020, 9, 8, 18, 15, 0).in_time_zone("Pacific Time (US & Canada)"), hours: "2", minutes: "48", seconds: "35", pace: "6:26", notes: "Bib#: 1356", city: "Los Angeles", gear_id: Gear.find_shoe("Adios 4").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('850'), state_id: State.find_by_abbr("CA").id, run_type_id: RunType.named("Easy Run").id, user_id: user_id)
puts @run.inspect
puts ""
puts ""
