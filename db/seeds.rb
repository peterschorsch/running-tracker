...
puts @run.inspect
@run = Run.find_or_create_by(name: "Rock 'n' Roll Chicago Half Marathon", distance: BigDecimal('13.1'), start_time: DateTime.new(2017, 7, 15, 6, 30, 0).in_time_zone("Central Time (US & Canada)"), hours: "1", minutes: "33", seconds: "09", pace: "7:27", notes: "Bib#: 1386", city: "Chicago", gear_id: Gear.find_shoe("Ravenna 8").id, elevation_gain: BigDecimal('150'), avg_heart_rate: 0, max_heart_rate: 0, state_id: State.find_by_abbr("IL").id, run_type_id: RunType.named("Race").id, user_id: user_id)
puts @run.inspect
...
puts @run.inspect
@run = Run.find_or_create_by(name: "Testing", start_time: DateTime.new(2020, 9, 5, 10, 0, 0).in_time_zone("Pacific Time (US & Canada)"), hours: "2", minutes: "48", seconds: "35", pace: "6:26", notes: "Bib#: 1356", city: "Los Angeles", gear_id: Gear.find_shoe("Adios 4").id, distance: BigDecimal('26.2'), elevation_gain: BigDecimal('850'), avg_heart_rate: 171, max_heart_rate: 190, state_id: State.find_by_abbr("CA").id, run_type_id: RunType.named("Long Run").id, user_id: user_id)
puts @run.inspect
@run = Run.find_or_create_by(name: "Testing 2", start_time: DateTime.new(2020, 9, 8, 18, 15, 0).in_time_zone("Pacific Time (US & Canada)"), hours: "2", minutes: "48", seconds: "35", pace: "6:26", notes: "Bib#: 1356", city: "Los Angeles", gear_id: Gear.find_shoe("Adios 4").id, distance: BigDecimal('26.2'), elevation_gain: BigDecimal('850'), avg_heart_rate: 171, max_heart_rate: 190, state_id: State.find_by_abbr("CA").id, run_type_id: RunType.named("Easy Run").id, user_id: user_id)
puts @run.inspect
puts ""
puts ""
