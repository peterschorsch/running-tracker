...
puts "----------RACES FOR MY ACCOUNT----------"
  ...
  @run = Run.find_or_create_by(name: "4th Annual Saluki Kickoff 5K", planned_mileage: BigDecimal('3.1'), mileage_total: BigDecimal('3.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "1199", pace: "6:24", shoe_id: @my_account.shoes.find_shoe("Wave Rider 15").id, elevation_gain: BigDecimal('0'), city: "Carbondale", state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: @monthly_total.id, completed_run: true)
  puts @run.inspect
  ...
  @monthly_total = MonthlyTotal.create_zero_totals(@my_account.id, @yearly_total.id, run_date.beginning_of_month, run_date.end_of_month)
  @run = Run.find_or_create_by(name: "5th Annual Saluki Kickoff 5K", planned_mileage: BigDecimal('3.1'), mileage_total: BigDecimal('3.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "1101", pace: "5:55", shoe_id: @my_account.shoes.find_shoe("Wave Rider 15").id, elevation_gain: BigDecimal('0'), city: "Carbondale", state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: @monthly_total.id, completed_run: true)
  puts @run.inspect
  ...
  @run = Run.find_or_create_by(name: "Chicago Chinatown 5K & Youth Run", planned_mileage: BigDecimal('3.1'), mileage_total: BigDecimal('3.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "1199", pace: "6:24", shoe_id: @my_account.shoes.find_shoe("Ravenna 8").id, elevation_gain: BigDecimal('0'), city: "Chicago", state_id: illinois_state_id, notes: "Bib #: 438", run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2017, 7, 15, 13, 30, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Rock 'n' Roll Chicago Half Marathon", planned_mileage: BigDecimal('13.1'), mileage_total: BigDecimal('13.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "5589", pace: "7:27", notes: "Bib#: 1386", city: "Chicago", shoe_id: @my_account.shoes.find_shoe("Ravenna 8").id, elevation_gain: BigDecimal('64'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2017, 9, 17, 14, 0, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Fox Valley Marathon", planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "11477", pace: "7:18", notes: "Bib#: 727", city: "St. Charles", shoe_id: @my_account.shoes.find_shoe("Ravenna 8").id, elevation_gain: BigDecimal('326'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2017, 10, 22, 14, 0, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Naperville Half Marathon and 5K", planned_mileage: BigDecimal('13.1'), mileage_total: BigDecimal('13.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "5148", pace: "6:33", notes: "Bib#: 3800", city: "Naperville", shoe_id: @my_account.shoes.find_shoe("Ravenna 8").id, elevation_gain: BigDecimal('0'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  puts "----------2018----------"
  run_date = DateTime.new(2018, 5, 20, 14, 50, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Chicago Spring Half Marathon & 10k", start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "2301", pace: "6:11", notes: "Bib#: 8111", city: "Chicago", shoe_id: @my_account.shoes.find_shoe("Ravenna 9").id, planned_mileage: BigDecimal('6.2'), mileage_total: BigDecimal('6.2'), elevation_gain: BigDecimal('45'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, personal_best: true, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2018, 7, 14, 15, 0, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Chicago Chinatown 5K & Youth Run", start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "1104", pace: "5:49", notes: "Bib#: 36", city: "Chicago", shoe_id: @my_account.shoes.find_shoe("Ravenna 9").id, planned_mileage: BigDecimal('3.1'), mileage_total: BigDecimal('3.1'), elevation_gain: BigDecimal('0'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2018, 7, 21, 13, 30, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Rock 'n' Roll Chicago Half Marathon", start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "4878", pace: "6:12", notes: "Bib#: 1346", city: "Chicago", shoe_id: @my_account.shoes.find_shoe("Ravenna 9").id, planned_mileage: BigDecimal('13.1'), mileage_total: BigDecimal('13.1'), elevation_gain: BigDecimal('64'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2018, 9, 16, 14, 0, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Fox Valley Marathon", start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "10308", pace: "6:33", notes: "Bib#:  622", city: "St. Charles", shoe_id: @my_account.shoes.find_shoe("Ravenna 9").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('326'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2018, 10, 7, 14, 30, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Bank of America Chicago Marathon", start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "9971", pace: "6:21", notes: "Bib#: 6084", city: "Chicago", shoe_id: @my_account.shoes.find_shoe("Ravenna 9").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('242'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2018, 10, 21, 14, 0, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Naperville Half Marathon and 5K", start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "4797", pace: "6:07", notes: "Bib#: 1473", city: "Naperville", shoe_id: @my_account.shoes.find_shoe("Ravenna 9").id, planned_mileage: BigDecimal('13.1'), mileage_total: BigDecimal('13.1'), elevation_gain: BigDecimal('0'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  puts "----------2019----------"
  run_date = DateTime.new(2019, 4, 15, 17, 02, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Boston Marathon", start_time: run_date.in_time_zone("Eastern Time (US & Canada)"), time_in_seconds: "10628", pace: "6:46", notes: "Bib#: 1183", city: "Boston", shoe_id: @my_account.shoes.find_shoe("Ravenna 10").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('655'), state_id: State.find_by_abbr("MA").id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2019, 7, 21, 13, 30, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Rock 'n' Roll Chicago Half Marathon", start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "4784", pace: "6:05", notes: "Bib#: 1175", city: "Chicago", shoe_id: @my_account.shoes.find_shoe("Kinvara 10").id, planned_mileage: BigDecimal('13.1'), mileage_total: BigDecimal('13.1'), elevation_gain: BigDecimal('64'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, personal_best: true, completed_run: true)
  puts @run.inspect
  ...
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Bucktown 5K Run", start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "1084", pace: "5:49", city: "Chicago", notes: "Bib#: 4291", shoe_id: @my_account.shoes.find_shoe("Adios 4").id, planned_mileage: BigDecimal('3.1'), mileage_total: BigDecimal('3.1'), elevation_gain: BigDecimal('0'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, personal_best: true, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2019, 10, 13, 14, 30, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Bank of America Chicago Marathon", start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "9788", pace: "6:14", notes: "Bib#: 11184", city: "Chicago", shoe_id: @my_account.shoes.find_shoe("Adios 4").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('100'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, personal_best: true, completed_run: true)
  puts @run.inspect

  run_date = DateTime.new(2019, 11, 3, 17, 42, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "TCS New York City Marathon", start_time: run_date.in_time_zone("Eastern Time (US & Canada)"), time_in_seconds: "11236", pace: "7:09", notes: "Bib#: 2052", city: "New York City", shoe_id: @my_account.shoes.find_shoe_with_color("Cloudswift", "Rock/Slate").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('830'), state_id: State.find_by_abbr("NY").id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect

  puts "----------2020----------"
  run_date = DateTime.new(2020, 3, 8, 13, 55, 0)
  monthly_total_id = MonthlyTotal.of_month(run_date).id
  @run = Run.find_or_create_by(name: "Skechers Los Angeles Marathon", start_time: run_date, time_in_seconds: "10115", pace: "6:26", notes: "Bib#: 1356", city: "Los Angeles", shoe_id: @my_account.shoes.find_shoe("Adios 4").id, planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), elevation_gain: BigDecimal('850'), state_id: State.find_by_abbr("CA").id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
  puts @run.inspect
