...
@run = Run.find_or_create_by(name: "4th Annual Saluki Kickoff 5K", planned_mileage: BigDecimal('3.1'), mileage_total: BigDecimal('3.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "1199", pace_minutes: "6", pace_seconds: "24", shoe_id: @my_account.shoes.find_shoe("Wave Rider 15").id, elevation_gain: BigDecimal('0'), city: "Carbondale", state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: @monthly_total.id, completed_run: true)
puts @run.inspect
...
@monthly_total = MonthlyTotal.create_zero_totals(@my_account.id, @yearly_total.id, run_date.beginning_of_month, run_date.end_of_month)
@run = Run.find_or_create_by(name: "5th Annual Saluki Kickoff 5K", planned_mileage: BigDecimal('3.1'), mileage_total: BigDecimal('3.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "1101", pace_minutes: "5", pace_seconds: "55", shoe_id: @my_account.shoes.find_shoe("Wave Rider 15").id, elevation_gain: BigDecimal('0'), city: "Carbondale", state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: @monthly_total.id, completed_run: true)
puts @run.inspect
...
@run = Run.find_or_create_by(name: "Chicago Chinatown 5K & Youth Run", planned_mileage: BigDecimal('3.1'), mileage_total: BigDecimal('3.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "1199",  pace_minutes: "6", pace_seconds: "24", shoe_id: @my_account.shoes.find_shoe("Ravenna 8").id, elevation_gain: BigDecimal('0'), city: "Chicago", state_id: illinois_state_id, notes: "Bib #: 438", run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
puts @run.inspect

run_date = DateTime.new(2017, 7, 15, 13, 30, 0)
monthly_total_id = MonthlyTotal.of_month(run_date).id
@run = Run.find_or_create_by(name: "Rock 'n' Roll Chicago Half Marathon", planned_mileage: BigDecimal('13.1'), mileage_total: BigDecimal('13.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "5589",  pace_minutes: "7", pace_seconds: "27", notes: "Bib#: 1386", city: "Chicago", shoe_id: @my_account.shoes.find_shoe("Ravenna 8").id, elevation_gain: BigDecimal('64'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
puts @run.inspect

run_date = DateTime.new(2017, 9, 17, 14, 0, 0)
monthly_total_id = MonthlyTotal.of_month(run_date).id
@run = Run.find_or_create_by(name: "Fox Valley Marathon", planned_mileage: BigDecimal('26.2'), mileage_total: BigDecimal('26.2'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "11477", pace_minutes: "7", pace_seconds: "18", notes: "Bib#: 727", city: "St. Charles", shoe_id: @my_account.shoes.find_shoe("Ravenna 8").id, elevation_gain: BigDecimal('326'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
puts @run.inspect

run_date = DateTime.new(2017, 10, 22, 14, 0, 0)
monthly_total_id = MonthlyTotal.of_month(run_date).id
@run = Run.find_or_create_by(name: "Naperville Half Marathon and 5K", planned_mileage: BigDecimal('13.1'), mileage_total: BigDecimal('13.1'), start_time: run_date.in_time_zone("Central Time (US & Canada)"), time_in_seconds: "5148", pace_minutes: "6", pace_seconds: "33", notes: "Bib#: 3800", city: "Naperville", shoe_id: @my_account.shoes.find_shoe("Ravenna 8").id, elevation_gain: BigDecimal('0'), state_id: illinois_state_id, run_type_id: run_type_id, user_id: @my_account.id, monthly_total_id: monthly_total_id, completed_run: true)
puts @run.inspect
