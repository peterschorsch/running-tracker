...
@shoe = Shoe.create_with(:shoe_brand_id => ShoeBrand.named("DEFAULT").id, :model => model, :color_way => color_way, :forefoot_stack => 0, :heel_stack => 0, :heel_drop => 0, :previous_mileage => 0, :weight => 0, :size => 8.5, :shoe_type => "Neutral", :default => false, :purchased_on => Date.today, :first_used_on => Date.today,
